...
def read_config(default_path=str(pathlib.Path.home())+'/.config/subnya/config.yml'):
    """
     读取subnya的配置文件
    """
    ...
    if os.path.exists(default_path):
        ...
        result['celery_broker'] = 'redis://localhost:6379'
        result['celery_backend'] =  'redis://localhost:6379'
